4.1 Connecting to the Offensive Pi 
...
4.1.1 Connecting to the Offensive Pi After Powering On
...
4.1.2 Enabling Networking Features After Startup
...
4.2.1 Deauthentication Attack | Layer 2
...
4.2.4 ROS2 Dynamic Man in the Middle Attack | Layer 5
...
4.2.4.1 Man in the Middle Attack with Keyboard Control 
